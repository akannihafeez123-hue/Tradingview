#!/usr/bin/env node
/* =========================================================
   OMNI INSTITUTIONAL AI — SINGLE FILE ENGINE
   No package.json | No wasmer.toml | No simulation
   Node >= 18
========================================================= */
...
async function newsScore(){
  ...
  const r=await fetchJSON(`https://newsapi.org/v2/top-headlines?q=crypto&apiKey=${NEWS_API_KEY}`);
